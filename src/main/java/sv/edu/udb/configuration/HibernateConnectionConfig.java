...
public class HibernateConnectionConfig {
    ...
    public HibernateConnectionConfig(
            final @Value("${spring.datasource.driverClassName}") String dbDriver,
            final @Value("${spring.datasource.url}") String dbUrl,
            final @Value("${spring.datasource.username}") String dbUsername,
            final @Value("${spring.datasource.password}") String dbPassword,
            final @Value("${spring.jpa.hibernate.ddl-auto}") String hibernateDdlAuto,
            final @Value("${spring.jpa.database-platform}") String hibernateDialect) {
